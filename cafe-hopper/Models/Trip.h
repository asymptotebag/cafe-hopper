...
@property (strong, nonatomic) NSMutableArray<NSString *> *stops;

+ (void)createTripWithName:(NSString *)tripName stops:(NSMutableArray<NSString *> * _Nullable)stops completion:(PFBooleanResultBlock)completion;
